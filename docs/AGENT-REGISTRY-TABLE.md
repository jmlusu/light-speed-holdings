...
| 37 | `marketing-owner` | Marketing Owner | `cmo` | None | Own the marketing service module and marketing SOP.; Define campaign and attribution metrics.; Coordinate brand guidelines with the CMO. |
