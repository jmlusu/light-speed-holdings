# H-A-O-M-T-G-V: What Running a 90-Agent Company Taught Us About Governance
...
90 agents across 20 departments, each with a documented role, a permission
...
Each of our 90 agents is a discrete persona with an explicit domain scope, a
...
it safe enough to run every day. The numbers are the credibility: 90 agents,
...
- **Fact checklist:** 90 agents / 20 departments (`docs/Pharos/positioning.md:61`),
