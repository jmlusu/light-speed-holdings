...
| A | What work can agents perform? | 144 role-bounded personas defined in `company-registry.yaml`, each with explicit domain scope and permission boundary |
...
**The proof.** 144 personas in `company-registry.yaml`, compiled by a Jinja2
...
wins and the source should be updated. Figures quoted (144 agents, 20
