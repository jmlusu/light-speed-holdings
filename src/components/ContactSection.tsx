            ...
            {contactSubmitted ? (
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
<label htmlFor="ct-executive-name" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
  Executive Name *
</label>
<input
  ...
  required
                  ...
                  <div>
<label htmlFor="ct-executive-title" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
  Executive Title *
</label>
<input
  ...
  required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
<label htmlFor="ct-organization" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
  Institution / Entity *
</label>
<input
  id="ct-organization"
  ...
  required
                  ...
                  <div>
<label htmlFor="ct-email" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
  Official Email *
</label>
<input
  id="ct-email"
  ...
  required
                ...
                <div>
<label htmlFor="ct-scope" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
...
<select
  id="ct-scope"
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-xl border text-xs outline-none focus:border-ls-red transition-colors font-medium ${
                      isLight
                        ? 'bg-ls-grey-light/90 border-ls-grey-dark text-ls-navy shadow-inner'
                        : 'bg-ls-navy border-ls-white/20 text-ls-white shadow-inner'
                    }`}
                  >
                ...
                <div>
<label htmlFor="ct-objective" className={`block text-[11px] font-body tracking-wider mb-1 font-bold ${isLight ? 'text-ls-grey-dark' : 'text-ls-grey-light-text'}`}>
  ...
  rows={3}
                ...
                <div className="pt-2 space-y-3">
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-3.5 rounded-xl bg-ls-red text-ls-white font-bold text-xs tracking-widest transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-ls-red/25 active:scale-98 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
