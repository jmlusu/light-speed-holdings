      ...
      <div
        className={`relative w-full max-w-2xl rounded-3xl border shadow-2xl overflow-hidden max-h-[90vh] flex flex-col ${
          isLight
            ...
            : 'bg-ls-navy text-zinc-100 border-white/15'
        }`}
      >
        {/* Modal Header */}
        <div className={`flex items-center justify-between p-6 border-b shrink-0 relative z-10 ${
          isLight ? 'border-slate-200 bg-slate-50/80' : 'border-white/10 bg-ls-navy/60'
        }`}>
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-ls-red flex items-center justify-center text-white shadow-xs">
          ...
          <button
            ...
            className={`relative z-50 p-2 rounded-full transition-all cursor-pointer border shrink-0 ${
              isLight
                ...
                : 'hover:bg-white/20 text-zinc-300 hover:text-white border-white/20 bg-ls-navy/80 shadow-md'
            }`}
          >
            <X className="w-5 h-5" />
          </button>
          ...
          {submitted ? (
            <div className="py-12 text-center space-y-4">
              ...
              <div className="pt-4">
                <button
                  ...
                  className="px-6 py-2.5 rounded-full bg-ls-red hover:bg-ls-red text-white font-bold text-xs tracking-widest cursor-pointer shadow-md shadow-ls-red/25"
                >
                  Return to Platform
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <input
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-xl border text-xs outline-none focus:border-ls-red transition-colors font-medium ${
                      isLight
                        ...
                        : 'border-white/20 bg-ls-navy text-white placeholder:text-zinc-400 shadow-inner'
                    }`}
                  />
                </div>
                  ...
                  <select
                    ...
                    className={`w-full px-3.5 py-2.5 rounded-xl border text-xs outline-none focus:border-ls-red transition-colors font-medium ${
                      isLight
                        ...
                        : 'border-white/20 bg-ls-navy text-white shadow-inner'
                    }`}
                  >
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-full bg-ls-red hover:bg-ls-red text-white font-bold text-xs tracking-widest transition-all flex items-center gap-2 cursor-pointer shadow-md shadow-ls-red/20"
                >
