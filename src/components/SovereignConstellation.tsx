  ...
  const nodes: NodeData[] = [
    {
      ...
      desc: 'The primary cradle of LIGHTSPEED HOLDINGS LIMITED where the 144-agent orchestration platform is proven in-house and sovereign offline-first architectures are engineered for Southern Africa.',
      pos: { x: 50, y: 48 }
    },
    {
      id: 'zambia',
