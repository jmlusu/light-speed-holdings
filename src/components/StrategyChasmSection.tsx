    ...
    <section id="problem" className={`py-24 px-4 sm:px-8 max-w-7xl mx-auto w-full border-t ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className={`p-8 rounded-3xl border transition-all flex flex-col justify-between ${
          isLight ? 'bg-ls-white/95 border-ls-grey-dark text-ls-navy shadow-lg' : 'bg-ls-navy/80 border-ls-white/15 text-ls-grey-light-text shadow-xl'
        }`}>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-2xl font-body font-black text-ls-red">01</span>
              <span className="text-[10px] font-body tracking-widest px-2.5 py-0.5 rounded-full border border-ls-red/30 text-ls-red bg-ls-red/10 font-bold">
                THE SLIDE TRAP
              </span>
            </div>
            <h3 className={`text-xl font-bold tracking-tight ${isLight ? 'text-ls-navy' : 'text-ls-white'}`}>Static Strategy Decks</h3>
            <p className="text-justify text-xs sm:text-sm leading-relaxed text-ls-grey-light-text">
          ...
          <div className={`pt-6 border-t text-xs font-body flex justify-between font-semibold ${isLight ? 'border-ls-grey-dark' : 'border-ls-white/10'} text-ls-grey-light-text`}>
            <span>LATENCY: 6-9 MONTHS</span>
            <span className="text-ls-red font-bold">CODE SHIPPED: 0%</span>
          </div>
        </div>
        </Reveal>
        ...
        <div className={`p-8 rounded-3xl border transition-all flex flex-col justify-between ${
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-2xl font-body font-black text-ls-red">02</span>
              <span className="text-[10px] font-body tracking-widest px-2.5 py-0.5 rounded-full border border-ls-cyan/30 text-ls-cyan bg-ls-cyan/10 font-bold">
                THE SILO TAX
              </span>
            </div>
            <h3 className={`text-xl font-bold tracking-tight ${isLight ? 'text-ls-navy' : 'text-ls-white'}`}>Fragmented Knowledge Pools</h3>
            <p className="text-justify text-xs sm:text-sm leading-relaxed text-ls-grey-light-text">
        ...
        <div className={`p-8 rounded-3xl border transition-all flex flex-col justify-between ${
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-2xl font-body font-black text-ls-red">03</span>
              <span className="text-[10px] font-body tracking-widest px-2.5 py-0.5 rounded-full border border-ls-cyan/30 text-ls-cyan bg-ls-cyan/10 font-bold">
                THE TOY PLAYGROUND
              </span>
            </div>
            <h3 className={`text-xl font-bold tracking-tight ${isLight ? 'text-ls-navy' : 'text-ls-white'}`}>Ungoverned Ad-Hoc AI</h3>
            <p className="text-justify text-xs sm:text-sm leading-relaxed text-ls-grey-light-text">
