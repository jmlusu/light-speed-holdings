...
export const CorporateLanding: React.FC<CorporateLandingProps> = ({
  ...
  return (
    <div className={`relative z-10 w-full transition-colors duration-300 ${
      ...
      <section id="hero" className="relative min-h-[92vh] flex flex-col justify-center pt-6 sm:pt-10 pb-16 px-4 sm:px-8 max-w-7xl mx-auto w-full">
            ...
            <div className={`p-6 sm:p-7 rounded-3xl max-w-md w-full transition-all duration-300 relative overflow-hidden ${
              ...
              <div className={`flex items-center justify-between pb-3.5 border-b ${isLight ? 'border-black/10' : 'border-white/10'}`}>
                <div className="flex items-center gap-2 pl-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-orange-500 shadow-[0_0_8px_rgba(230,57,70,0.9)]" />
                      ...
                      {coreCapabilities.map((c, cIdx) => (
                        <button
                          ...
                          className={`h-2.5 rounded-full transition-all ${
                            activePillar === cIdx
                              ? 'bg-orange-500 shadow-[0_0_6px_rgba(230,57,70,0.8)]'
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-5 relative group">
                  <div className={`relative rounded-2xl overflow-hidden border shadow-xl p-5 ${
                    isLight ? 'border-slate-300 bg-slate-900 text-white' : 'border-white/20 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black text-white'
                  }`}>
                    {/* Top Console Bar */}
                    <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-4">
                      <div className="flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse" />
                        <span className="font-mono text-[10px] text-orange-400 font-bold tracking-wider uppercase">
                          SADC SOVEREIGN FIELD TELEMETRY
                        </span>
                      </div>
                      <span className="font-mono text-[9px] text-zinc-400">STATUS: VERIFIED</span>
                    </div>

                    {/* Schematic Visualization Canvas */}
                    <div className="space-y-4 py-2">
                      <div className="p-3.5 rounded-xl bg-black/60 border border-white/10 space-y-2">
                        <div className="flex justify-between text-[11px] font-mono">
                          <span className="text-zinc-400">DOMAIN NODE:</span>
                          <span className="text-amber-400 font-bold uppercase">{selectedIndustry}</span>
                        </div>
                        <div className="flex justify-between text-[11px] font-mono">
                          <span className="text-zinc-400">RESIDENCY:</span>
                          <span className="text-emerald-400">ON-SOIL (MALAWI / SADC)</span>
                        </div>
                        <div className="flex justify-between text-[11px] font-mono">
                          <span className="text-zinc-400">LATENCY / SLI:</span>
                          <span className="text-white">18ms // 99.98% AUDITED</span>
                        </div>
                      </div>

                      {/* Waveform Telemetry Visual */}
                      <div className="h-10 bg-black/80 rounded-lg p-2 flex items-center gap-1 border border-orange-500/20">
                        {Array.from({ length: 28 }).map((_, i) => (
                          <div
                            key={i}
                            className="flex-1 bg-orange-500/60 rounded-full transition-all duration-300"
                            style={{ height: `${20 + ((i * 17 + 7) % 70)}%` }}
                          />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="mt-4 p-2.5 rounded-xl bg-black/75 border border-white/10">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-14">
          <div className="lg:col-span-8 space-y-4">
            <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full border border-amber-500/40 bg-gradient-to-r from-amber-500/15 via-orange-500/10 to-transparent text-amber-500 font-mono text-[11px] tracking-widest shadow-sm">
              <span className="w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_8px_rgba(245,131,143,1)] animate-pulse" />
          ...
          >
            <div className={`p-4 rounded-3xl relative overflow-hidden backdrop-blur-xl border ${
              ...
              {/* Pharos Beacon Optical Telemetry Display */}
              <div className="relative rounded-2xl overflow-hidden mb-3 border border-amber-500/30 p-4 bg-gradient-to-br from-[#1c0507] via-[#160808] to-[#040403] flex flex-col justify-between min-h-[144px]">
                <div className="flex items-center justify-between">
                ...
                <div className="py-2">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[11px] font-mono text-zinc-300">WAVELENGTH:</span>
                    <span className="text-[11px] font-mono text-amber-300 font-bold">589.0 nm (SODIUM-D)</span>
                  </div>
                  <div className="h-1.5 w-full bg-black/60 rounded-full overflow-hidden border border-amber-500/30">
                    <div className="h-full bg-gradient-to-r from-amber-500 to-amber-300 w-5/6 animate-pulse" />
                  </div>
                </div>

                <div className="flex items-center justify-between text-[10px] font-mono text-amber-300 border-t border-amber-500/20 pt-1.5">
                  <span className="font-bold">LAKE MALAWI // PHAROS STATION</span>
                  <span className="text-emerald-400">42 KM LINE-OF-SIGHT</span>
                </div>
              </div>
              ...
              <div className="relative z-10 space-y-2.5">
                <div className="flex items-center justify-between border-b border-amber-500/20 pb-2">
                  <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(230,57,70,1)] animate-ping" />
