      ...
      <div className="w-full max-w-6xl pointer-events-auto">
          <div className={`flex items-center justify-between px-4 sm:px-6 py-2 sm:py-2.5 rounded-full transition-all duration-300 shadow-xl backdrop-blur-xl ${
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                onClick={() => onRequestBriefing('Book Discovery Call')}
          ...
          {mobileMenuOpen && (
            <div className={`mt-2 p-5 rounded-3xl border shadow-2xl lg:hidden flex flex-col gap-1 animate-in fade-in slide-in-from-top-2 ${
              isLight ? 'hardware-chassis-light text-slate-800' : 'hardware-chassis-dark text-zinc-100'
            }`}>
              ...
              <button
                onClick={() => {
                  ...
                  onRequestBriefing('Book Discovery Call');
                }}
