...
| `AgentRoster.tsx` & `AgentModal.tsx` | Verifies filtering 90 agents across 20 departments, searching agent cards, and displaying OpenCode tool permission blocks. |
