...
class TestKPIHistoryStore:
    ...
    def test_store_snapshot_returns_count(
        self, store: KPIHistoryStore, sample_snapshot: dict
    ) -> None:
    ...
    def test_get_latest_after_multiple_snapshots(
        self, store: KPIHistoryStore, sample_snapshot: dict
    ) -> None:
    ...
    def test_store_multiple_snapshots_accumulates(
        self, store: KPIHistoryStore, older_snapshot: dict, sample_snapshot: dict
    ) -> None:
...
class TestTrendAnalysis:
    ...
    def test_trend_computes_changes(
        self, store: KPIHistoryStore, older_snapshot: dict, sample_snapshot: dict
    ) -> None:
    ...
    def test_trend_with_single_snapshot(
        self, store: KPIHistoryStore, sample_snapshot: dict
    ) -> None:
    ...
    def test_trend_filter_by_kpi_keys(
        self, store: KPIHistoryStore, older_snapshot: dict, sample_snapshot: dict
    ) -> None:
...
class TestAlertEngine:
    ...
    def test_add_rules(self) -> None:
        ...
        rules = [
            AlertRule(
                name="r1", department="*", kpi_key="failure_rate", operator="gt", threshold=5.0
            ),
            AlertRule(
                name="r2",
                department="engineering",
    ...
    def test_remove_rule(self) -> None:
        ...
        engine = AlertEngine()
        engine.add_rule(
            AlertRule(name="test_rule", department="*", kpi_key="x", operator="gt", threshold=1)
        )
    ...
    def test_clear_rules(self) -> None:
        ...
        engine = AlertEngine()
        engine.add_rule(
            AlertRule(name="r1", department="*", kpi_key="x", operator="gt", threshold=1)
        )
        engine.add_rule(
            AlertRule(name="r2", department="*", kpi_key="y", operator="lt", threshold=10)
        )
        engine.clear_rules()
        assert engine.list_rules() == []
