---
name: no-ai-slop
description: Remove AI slop patterns from writing while preserving personal voice
license: MIT
metadata:
  version: "1.0.0"
  author: community
...
| 2 | Throat-clearing openers | "Here's the thing," | Cut and state the point |
| 3 | Faux-insight setups | "What nobody tells you," | Make claim stand on its own |
| 4 | Colon reveals | "The best part: it learns." | Plain sentence, sentence case after colon |
| 5 | Dramatic fragments | "That's it. That's the whole thing." | Complete sentences |
| 6 | Superficial analysis | "highlighting the team's commitment" | Cut `-ing` clauses |
| 7 | Importance puffery | "marks a pivotal moment" | State the fact |
| 8 | Weasel attribution | "experts agree," "studies show" | Name source or cut |
| 9 | Synonym cycling | Rotating terms for style | Use clear word consistently |
| 10 | Negative listing | "Not a X. Not a Y. A Z." | Just say Z |
| 11 | Dramatic fragmentation | "X. And Y. And Z." | Use complete sentences |
| 12 | Robotic rhythm | Repeated sentence shapes | Vary the shape |
| 13 | Rhetorical setups | "What if I told you..." | Drop and make the point |
| 14 | Fake-profound kickers | Final "deep" line | Delete, end on concrete sentence |
| 15 | Summary-recap endings | "In conclusion," "Overall" | End on last concrete point |
| 16 | Formatting slop | Emoji in headings, bold mid-sentence | Format follows content |
| 17 | Em dashes | Used as default rhythm crutch | Use sparingly: none short, 1-2 long |
| 18 | Negative listing | "Not a X. Not a Y. A Z." | Just say Z |
| 19 | Interpretive metadiscourse | "The key point is," "As you can see" | Delete or replace with facts |
| 20 | Fake-strong verbs | "Made a decision" | Use direct verbs "decided" |

## Eval Checks (run after every edit)

Answer each check with pass or fail. If any check fails, fix the draft before returning it.
