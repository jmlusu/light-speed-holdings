...
- `AGENTS.md` line is the pointer → module/subproject `AGENTS.md` files are the per-area entry points (already in use: `marketing-site/AGENTS.md`, `website/AGENTS.md`).
