...
- Duplicate of archived pass docs change; freeing active slot for P2 public registry transform (user-approved 2026-09-24). Backfill script rides along and will be relocated into P2.
