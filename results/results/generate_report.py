...
def build_slide_02_executive_summary(prs: Presentation):
    ...
    add_bullet_list(
        slide, Inches(0.6), Inches(2.5), Inches(8.8), Inches(2.8), points, font_size=13, spacing=5
    )
...
def build_slide_04_phase_3a(prs: Presentation):
    ...
    add_bullet_list(
        slide, Inches(0.6), Inches(1.2), Inches(5.0), Inches(3.5), points, font_size=14, spacing=8
    )
    ...
    for j, (item, status) in enumerate(status_items):
        ...
        status_color = (
            ACCENT if status in ("READY", "OPERATIONAL", "ACTIVE", "ENABLED") else MID_GRAY
        )
        add_textbox(
            slide,
            card_x + Inches(2.2),
...
def build_slide_05_phase_3b(prs: Presentation):
    ...
    add_bullet_list(
        ...
        font_size=12,
        color=MID_GRAY,
        bullet_color=RGBColor(0xFF, 0x6B, 0x6B),
        spacing=6,
    )
...
def build_slide_08_files(prs: Presentation):
    ...
    add_accent_bar(slide, fx, ny, col_w, Inches(0.05), RGBColor(0xFF, 0xB8, 0x47))
...
def build_slide_09_unfinished(prs: Presentation):
    ...
    add_accent_bar(slide, warn_x, warn_y, Inches(0.06), warn_h, RGBColor(0xFF, 0xB8, 0x47))
    ...
    add_bullet_list(
        slide, Inches(0.6), Inches(2.5), Inches(8.8), Inches(2.8), points, font_size=14, spacing=7
    )
